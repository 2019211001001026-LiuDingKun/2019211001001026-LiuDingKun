			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<tr>
						...
						<td>${o.orderDate}</td>
						<%
							com.liudingkun.model.Order o=(com.liudingkun.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.liudingkun.dao.UserDao userDao=new com.liudingkun.dao.UserDao();
							String customerName=userDao.findById(con, String.valueOf(userId)).getUsername();
						%>
						<td><%=customerName %></td>
						<td>
						...
						<td class="cart_total">
							<%
								...
								String paymentType=com.liudingkun.model.Payment.findByPaymentId(con,n);
							%>
